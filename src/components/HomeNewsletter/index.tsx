    ...
    <section style={{ background: 'var(--color-pine)', padding: '88px 52px' }}>
      ...
      >
        <p style={{
          ...
          textTransform: 'uppercase', color: 'rgba(240,224,199,0.45)', marginBottom: 16,
        }}>
          Stay in the Loop
        </p>
        <h2 style={{
          ...
          fontWeight: 400, color: 'var(--color-linen)',
          marginBottom: 14, lineHeight: 1.15,
        }}>
          Get campaign updates delivered to you.
        </h2>
        <p style={{
          fontSize: 14, fontWeight: 300, lineHeight: 1.8,
          color: 'rgba(240,224,199,0.5)', marginBottom: 36,
        }}>
          News, announcements, and resources — straight to your inbox.
        </p>
        <form
